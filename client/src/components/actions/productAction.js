...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `/api/v1/products/all`;

      if (category) {
        link = `/api/v1/products/all?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings[gte]=${ratings}`;
      }
